...
def directory(node_list, root, whitelist):
    ...
    ...     {'path': '/tmp/scan_dir', 'parents': [], 'children': ['/tmp/scan_dir/run0', '/tmp/scan_dir/run1', '/tmp/scan_dir/run2'], 'name': 'scan_dir', 'type': 'project'},
    ...     {'path': '/tmp/scan_dir/run0', 'parents': ['/tmp/scan_dir'], 'children': ['/tmp/scan_dir/run0/run1'], 'name': 'run0', 'type': 'run'},
    ...     {'path': '/tmp/scan_dir/run0/run0', 'parents': [], 'children': ['/tmp/scan_dir/run0/run0/data'], 'name': 'run0', 'type': 'project'},
    ...     {'path': '/tmp/scan_dir/run0/run0/data', 'parents': ['/tmp/scan_dir/run0/run0'], 'children': [], 'name': 'data', 'type': 'run'},
    ...     {'path': '/tmp/scan_dir/run0/run1', 'parents': ['/tmp/scan_dir/run0'], 'children': [], 'name': 'run1', 'type': 'run'},
    ...     {'path': '/tmp/scan_dir/run1', 'parents': ['/tmp/scan_dir'], 'children': [], 'name': 'run1', 'type': 'run'},
    ...     {'path': '/tmp/scan_dir/run2', 'parents': ['/tmp/scan_dir'], 'children': [], 'name': 'run2', 'type': 'run'},
    ...     {'path': '/tmp/scan_dir/run3', 'parents': [], 'children': ['/tmp/scan_dir/run3/data'], 'name': 'run3', 'type': 'project'},
    ...     {'path': '/tmp/scan_dir/run3/data', 'parents': ['/tmp/scan_dir/run3'], 'children': [], 'name': 'data', 'type': 'run'}
    ... ]
    True
    >>> directory([], scandir, ["data"]) == [
    ...     {'path': '/tmp/scan_dir', 'parents': [], 'children': ['/tmp/scan_dir/run3'], 'name': 'scan_dir', 'type': 'project'},
    ...     {'path': '/tmp/scan_dir/run0', 'parents': [], 'children': ['/tmp/scan_dir/run0/run0'], 'name': 'run0', 'type': 'project'},
    ...     {'path': '/tmp/scan_dir/run0/run0', 'parents': ['/tmp/scan_dir/run0'], 'children': [], 'name': 'run0', 'type': 'run'},
    ...     {'path': '/tmp/scan_dir/run3', 'parents': ['/tmp/scan_dir'], 'children': [], 'name': 'run3', 'type': 'run'}
    ... ]
    True
